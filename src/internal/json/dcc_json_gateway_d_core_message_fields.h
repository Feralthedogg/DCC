#ifndef DCC_JSON_GATEWAY_D_CORE_MESSAGE_FIELDS_H
#define DCC_JSON_GATEWAY_D_CORE_MESSAGE_FIELDS_H
...
#include "internal/json/dcc_json_gateway_d_core_message_author_fields.h"
