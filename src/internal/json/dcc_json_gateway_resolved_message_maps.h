#ifndef DCC_JSON_GATEWAY_RESOLVED_MESSAGE_MAPS_H
#define DCC_JSON_GATEWAY_RESOLVED_MESSAGE_MAPS_H
...
dcc_status_t dcc_json_gateway_parse_resolved_message_map(
