...
#include "internal/gateway/dcc_gateway_emit_stage_resources_internal.h"

dcc_status_t dcc_gateway_emit_stage_instance(
    ...
    event.data.stage_instance = payload->stage_instance;
