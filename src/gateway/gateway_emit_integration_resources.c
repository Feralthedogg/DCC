...
#include "internal/gateway/dcc_gateway_emit_integration_resources_internal.h"

dcc_status_t dcc_gateway_emit_integration(
    ...
    event.data.integration = payload->integration;
