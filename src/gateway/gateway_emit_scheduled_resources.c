...
#include "internal/gateway/dcc_gateway_emit_scheduled_resources_internal.h"

dcc_status_t dcc_gateway_emit_scheduled_event(
    ...
    event.data.scheduled_event = payload->scheduled_event;
