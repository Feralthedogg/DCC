...
#define DCC_SLASH_COMMAND_OPTIONS(name_, description_, options_json_) \
    ((dcc_application_command_builder_t){ \
        .size = sizeof(dcc_application_command_builder_t), \
        .version = DCC_APPLICATION_COMMAND_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_DESCRIPTION | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_OPTIONS_JSON | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_TYPE, \
        .name = (name_), \
        .description = (description_), \
...
#define DCC_SLASH_COMMAND_NSFW(name_, description_) \
    ((dcc_application_command_builder_t){ \
        .size = sizeof(dcc_application_command_builder_t), \
        .version = DCC_APPLICATION_COMMAND_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_DESCRIPTION | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_TYPE | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_NSFW, \
        .name = (name_), \
        .description = (description_), \
        .type = DCC_APPLICATION_COMMAND_CHAT_INPUT, \
        .nsfw = 1U \
...
#define DCC_SLASH_COMMAND_DM(name_, description_, dm_permission_) \
    ((dcc_application_command_builder_t){ \
        .size = sizeof(dcc_application_command_builder_t), \
        .version = DCC_APPLICATION_COMMAND_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_DESCRIPTION | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_TYPE | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_DM_PERMISSION, \
        .name = (name_), \
        .description = (description_), \
        .type = DCC_APPLICATION_COMMAND_CHAT_INPUT, \
...
#define DCC_SLASH_COMMAND_DEFAULT_PERMISSIONS(name_, description_, permissions_) \
    ((dcc_application_command_builder_t){ \
        .size = sizeof(dcc_application_command_builder_t), \
        .version = DCC_APPLICATION_COMMAND_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_DESCRIPTION | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_TYPE | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_DEFAULT_MEMBER_PERMISSIONS, \
        .name = (name_), \
        .description = (description_), \
        .type = DCC_APPLICATION_COMMAND_CHAT_INPUT, \
...
#define DCC_USER_COMMAND_BUILDER(name_) \
    ((dcc_application_command_builder_t){ \
        .size = sizeof(dcc_application_command_builder_t), \
        .version = DCC_APPLICATION_COMMAND_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_BUILDER_PRESENT_TYPE, \
        .name = (name_), \
...
#define DCC_COMMAND_STRING_OPTION_CHOICES_JSON(name_, description_, required_, choices_json_) \
    ((dcc_application_command_option_builder_t){ \
        .size = sizeof(dcc_application_command_option_builder_t), \
        .version = DCC_APPLICATION_COMMAND_OPTION_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_DESCRIPTION | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_CHOICES_JSON | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_TYPE | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_REQUIRED, \
...
#define DCC_COMMAND_CHANNEL_OPTION_TYPES(name_, description_, required_, ...) \
    ((dcc_application_command_option_builder_t){ \
        .size = sizeof(dcc_application_command_option_builder_t), \
        .version = DCC_APPLICATION_COMMAND_OPTION_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_DESCRIPTION | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_CHANNEL_TYPES | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_TYPE | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_REQUIRED, \
...
#define DCC_COMMAND_SUBCOMMAND(name_, description_, ...) \
    ((dcc_application_command_option_builder_t){ \
        .size = sizeof(dcc_application_command_option_builder_t), \
        .version = DCC_APPLICATION_COMMAND_OPTION_BUILDER_VERSION, \
        .present = DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_NAME | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_DESCRIPTION | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_OPTIONS | DCC_APPLICATION_COMMAND_OPTION_BUILDER_PRESENT_TYPE, \
...
#define DCC_AUTOCOMPLETE_STRING_CHOICE(name_, value_) \
    ((dcc_autocomplete_choice_t){ \
        ...
        .present = DCC_AUTOCOMPLETE_CHOICE_PRESENT_NAME | DCC_AUTOCOMPLETE_CHOICE_PRESENT_VALUE, \
        .name = (name_), \
        .value_string = (value_), \
...
#define DCC_AUTOCOMPLETE_CHOICES(...) \
    ((dcc_autocomplete_builder_t){ \
        .size = sizeof(dcc_autocomplete_builder_t), \
        .version = DCC_AUTOCOMPLETE_BUILDER_VERSION, \
        .present = DCC_AUTOCOMPLETE_BUILDER_PRESENT_CHOICES, \
