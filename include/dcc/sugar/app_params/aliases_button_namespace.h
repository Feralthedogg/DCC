#ifndef DCC_SUGAR_APP_PARAMS_ALIASES_BUTTON_NAMESPACE_H
#define DCC_SUGAR_APP_PARAMS_ALIASES_BUTTON_NAMESPACE_H

#include <dcc/sugar/app_params/button_namespace.h>
...
#endif /* DCC_SUGAR_APP_PARAMS_ALIASES_BUTTON_NAMESPACE_H */
