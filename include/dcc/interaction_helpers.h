...
DCC_API dcc_status_t dcc_interaction_reply_message(
    ...
    const dcc_message_builder_t *message, dcc_rest_result_fn cb,
    void *user_data);
...
DCC_API dcc_status_t dcc_interaction_reply_error(
    dcc_client_t *client, const dcc_interaction_t *interaction,
    const char *title, const char *description, dcc_rest_result_fn cb,
    void *user_data);
DCC_API dcc_status_t dcc_interaction_reply_success(
    dcc_client_t *client, const dcc_interaction_t *interaction,
    const char *title, const char *description, dcc_rest_result_fn cb,
    void *user_data);
DCC_API dcc_status_t dcc_interaction_defer(dcc_client_t *client,
...
DCC_API dcc_status_t dcc_interaction_show_modal(
    dcc_client_t *client, const dcc_interaction_t *interaction,
    const dcc_modal_builder_t *modal, dcc_rest_result_fn cb, void *user_data);
