...
DCC_API dcc_status_t dcc_rest_get_current_user(dcc_client_t *client,
                                               dcc_rest_cb cb, void *user_data);

DCC_API dcc_status_t dcc_rest_modify_current_user(dcc_client_t *client,
...
DCC_API dcc_status_t dcc_rest_get_user(dcc_client_t *client,
                                       dcc_snowflake_t user_id, dcc_rest_cb cb,
                                       void *user_data);

DCC_API dcc_status_t dcc_rest_get_current_user_connections(dcc_client_t *client,
                                                           dcc_rest_cb cb,
                                                           void *user_data);
