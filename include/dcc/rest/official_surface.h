 ...
 */
DCC_API dcc_status_t dcc_rest_get_gateway(dcc_client_t *client, dcc_rest_cb cb,
                                          void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_modify_current_application(dcc_client_t *client,
...
DCC_API dcc_status_t dcc_rest_get_activity_instance(
    ...
    const char *instance_id, dcc_rest_cb cb, void *user_data);
 ...
 * `source_guild_id`.
 */
DCC_API dcc_status_t dcc_rest_send_soundboard_sound(dcc_client_t *client,
...
DCC_API dcc_status_t dcc_rest_build_soundboard_send_body(
    const dcc_soundboard_send_params_t *params, char **out_json);
 ...
 */
DCC_API dcc_status_t dcc_rest_get_sku_subscriptions(dcc_client_t *client,
...
DCC_API dcc_status_t dcc_rest_get_sku_subscription(
    ...
    dcc_snowflake_t subscription_id, dcc_rest_cb cb, void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_get_entitlement(dcc_client_t *client,
 ...
 */
DCC_API dcc_status_t dcc_rest_create_lobby(dcc_client_t *client,
                                           const char *json_body,
                                           dcc_rest_cb cb, void *user_data);

DCC_API dcc_status_t dcc_rest_build_lobby_body(const dcc_lobby_params_t *params,
                                               char **out_json);

DCC_API dcc_status_t dcc_rest_create_lobby_params(
    dcc_client_t *client, const dcc_lobby_params_t *params, dcc_rest_cb cb,
    void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_create_or_join_lobby(dcc_client_t *client,
                                                   const char *json_body,
                                                   dcc_rest_cb cb,
                                                   void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_get_lobby(dcc_client_t *client,
 ...
 */
DCC_API dcc_status_t dcc_rest_modify_lobby(dcc_client_t *client,
                                           dcc_snowflake_t lobby_id,
                                           const char *json_body,
                                           dcc_rest_cb cb, void *user_data);
...
DCC_API dcc_status_t dcc_rest_modify_lobby_params(
    ...
    const dcc_lobby_params_t *params, dcc_rest_cb cb, void *user_data);

/**
 * @brief Submits `DELETE /lobbies/{lobby.id}`.
 */
DCC_API dcc_status_t dcc_rest_delete_lobby(dcc_client_t *client,
                                           dcc_snowflake_t lobby_id,
                                           dcc_rest_cb cb, void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_add_lobby_member(dcc_client_t *client,
                                               dcc_snowflake_t lobby_id,
                                               dcc_snowflake_t user_id,
                                               const char *json_body,
                                               dcc_rest_cb cb, void *user_data);
...
DCC_API dcc_status_t dcc_rest_build_lobby_member_body(
    const dcc_lobby_member_params_t *params, char **out_json);
...
DCC_API dcc_status_t dcc_rest_bulk_update_lobby_members(
    dcc_client_t *client, dcc_snowflake_t lobby_id, const char *json_body,
    dcc_rest_cb cb, void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_remove_lobby_member(dcc_client_t *client,
                                                  dcc_snowflake_t lobby_id,
                                                  dcc_snowflake_t user_id,
                                                  dcc_rest_cb cb,
                                                  void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_leave_lobby(dcc_client_t *client,
                                          dcc_snowflake_t lobby_id,
                                          dcc_rest_cb cb, void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_link_lobby_channel(dcc_client_t *client,
                                                 dcc_snowflake_t lobby_id,
                                                 const char *json_body,
                                                 dcc_rest_cb cb,
                                                 void *user_data);
...
/**
 * @brief Submits `PATCH /lobbies/{lobby.id}/channel-linking` with an empty
 * body.
 */
DCC_API dcc_status_t dcc_rest_unlink_lobby_channel(dcc_client_t *client,
                                                   dcc_snowflake_t lobby_id,
                                                   dcc_rest_cb cb,
                                                   void *user_data);
 ...
 */
DCC_API dcc_status_t dcc_rest_send_lobby_message(dcc_client_t *client,
                                                 dcc_snowflake_t lobby_id,
                                                 const char *json_body,
                                                 dcc_rest_cb cb,
                                                 void *user_data);
...
DCC_API dcc_status_t dcc_rest_build_lobby_message_body(
    const dcc_lobby_message_params_t *params, char **out_json);
 ...
 */
DCC_API dcc_status_t dcc_rest_get_lobby_messages(dcc_client_t *client,
                                                 dcc_snowflake_t lobby_id,
                                                 const char *query,
                                                 dcc_rest_cb cb,
                                                 void *user_data);
