...
def main() -> int:
    ...
    required_cpack_excludes = {
        '"${separator}build': "build trees",
        '"${separator}CMakeFiles': "in-source CMakeFiles directories",
        '"${separator}CMakeCache[.]txt$"': "in-source CMake caches",
        '"${separator}cmake_install[.]cmake$"': "in-source install scripts",
        '"${separator}install_manifest[.]txt$"': "in-source install manifests",
        '"${separator}Testing': "in-source CTest output",
        '"${separator}site': "MkDocs output",
        '"${separator}target': "release artifacts",
        '"${separator}dist': "distribution artifacts",
        '"${separator}[.]venv': "Python virtualenvs",
        '"${separator}compile_commands[.]json$"': "compile_commands.json",
        '"${separator}__pycache__': "__pycache__ directories",
        '"[.]pyc$"': "Python bytecode",
        '"${separator}[.]DS_Store$"': ".DS_Store files",
        '"${separator}[.]env($|[.])"': "hidden .env files",
        '"${separator}[.]git${separator}"': ".git directories",
        '"${separator}[.]git$"': ".git worktree files",
        '"${separator}[.]superpowers${separator}"': "local agent reports",
        '"${separator}[.]worktrees${separator}"': "nested worktrees",
    }
    ...
    official_surface_package_entries = (
        ...
        "/tests/package_consumer/package_consumer_v2.c$",
