...
DPP_TO_DCC = {
    ...
    "channel_pins_get": {"dcc_rest_get_channel_pins"},
    ...
    "create_webhook": {"dcc_rest_create_webhook"},
    ...
    "delete_webhook_message": {"dcc_rest_delete_webhook_message"},
    "delete_webhook_with_token": {"dcc_rest_delete_webhook"},
    "direct_message_create": {"dcc_rest_create_direct_message", "dcc_rest_create_direct_message_builder"},
    "edit_webhook": {"dcc_rest_modify_webhook"},
    "edit_webhook_message": {"dcc_rest_modify_webhook_message"},
    "edit_webhook_with_token": {"dcc_rest_modify_webhook"},
    ...
    "execute_webhook": {"dcc_rest_execute_webhook"},
    ...
    "get_webhook_message": {"dcc_rest_get_webhook_message"},
    "get_webhook_with_token": {"dcc_rest_get_webhook"},
    ...
    "guild_add_member": {"dcc_rest_add_guild_member"},
    "guild_auditlog_get": {"dcc_rest_get_guild_audit_log"},
    "guild_ban_add": {"dcc_rest_create_guild_ban"},
    "guild_ban_delete": {"dcc_rest_delete_guild_ban"},
    "guild_begin_prune": {"dcc_rest_begin_guild_prune"},
    ...
    "guild_current_member_edit": {"dcc_rest_modify_current_guild_member"},
    "guild_delete_integration": {"dcc_rest_delete_guild_integration"},
    "guild_edit": {"dcc_rest_modify_guild"},
    "guild_edit_member": {"dcc_rest_modify_guild_member"},
    "guild_edit_onboarding": {
        "dcc_rest_modify_guild_onboarding",
        "dcc_rest_modify_guild_onboarding_params",
    },
    "guild_edit_welcome_screen": {"dcc_rest_modify_guild_welcome_screen"},
    "guild_edit_widget": {"dcc_rest_modify_guild_widget"},
    ...
    "guild_get_bans": {"dcc_rest_get_guild_bans"},
    ...
    "guild_get_members": {"dcc_rest_list_guild_members"},
    "guild_get_onboarding": {"dcc_rest_get_guild_onboarding"},
    "guild_get_preview": {"dcc_rest_get_guild_preview"},
    "guild_get_prune_counts": {"dcc_rest_get_guild_prune_count"},
    ...
    "guild_member_add_role": {"dcc_rest_add_guild_member_role"},
    ...
    "guild_member_move": {"dcc_rest_modify_guild_member"},
    "guild_member_remove_role": {"dcc_rest_remove_guild_member_role"},
    "guild_member_timeout": {"dcc_rest_modify_guild_member"},
    "guild_member_timeout_remove": {"dcc_rest_modify_guild_member"},
    "guild_messages_search": {"dcc_rest_guild_message_search", "dcc_rest_guild_message_search_params"},
    "guild_search_members": {"dcc_rest_search_guild_members"},
    "guild_set_nickname": {"dcc_rest_set_current_guild_member_nickname"},
    ...
    "interaction_followup_create": {"dcc_rest_interaction_followup_create"},
    "interaction_followup_delete": {"dcc_rest_interaction_followup_delete"},
    "interaction_followup_edit": {"dcc_rest_interaction_followup_edit"},
    "interaction_followup_edit_original": {"dcc_rest_interaction_original_response_edit"},
    ...
    "interaction_response_create": {"dcc_rest_interaction_response_create"},
    "interaction_response_edit": {"dcc_rest_interaction_original_response_edit"},
    ...
    "message_add_reaction": {"dcc_rest_add_message_reaction"},
    "message_create": {"dcc_rest_create_message"},
    ...
    "message_edit": {"dcc_rest_edit_message"},
    "message_edit_flags": {"dcc_rest_edit_message"},
    "message_get": {"dcc_rest_get_message"},
    "message_get_reactions": {"dcc_rest_get_message_reactions"},
    "message_pin": {"dcc_rest_pin_message"},
    "message_unpin": {"dcc_rest_unpin_message"},
    "messages_get": {"dcc_rest_get_channel_messages"},
    "nitro_sticker_get": {"dcc_rest_get_sticker"},
    "poll_end": {"dcc_rest_end_poll"},
    "poll_get_answer_voters": {"dcc_rest_get_poll_answer_voters"},
    "role_create": {"dcc_rest_create_guild_role"},
    "role_delete": {"dcc_rest_delete_guild_role"},
    "role_edit": {"dcc_rest_modify_guild_role"},
    "roles_edit_position": {"dcc_rest_modify_guild_role_positions"},
